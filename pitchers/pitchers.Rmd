...
unique_pitchers = unique(non_hit$pitcher_name) 
    ...
    sidebarLayout(
      sidebarPanel(
        selectInput(
          inputId = "pitcher",
          label = "Pitcher: ",
          choices  = filtered_unique_pitchers,
        ...
        selectInput(
          inputId = "pitch_type",
          label = "Pitch Type",
          choices = c("Playoff" = 1, "Regular Season" = 0),
          selected = ""),
        selectInput(
          inputId = "year",
          label = "Year",
          choices = c("Blowout" = 1, "All Games" = 0),
          selected = ""),
        selectInput(
          inputId = "ball",
...
output$plot = renderPlot({
    ...
    # Create a scatter plot of pitch locations
    p <- ggplot(filtered_data, aes(x = plate_x, y = plate_z)) +
      geom_point() +  # Scatter plot of pitch locations
      labs(x = "Horizontal Location", y = "Vertical Location") +  # Axis labels
